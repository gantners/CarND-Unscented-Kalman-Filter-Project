...
public:
    ...
    void PredictRadarMeasurement(VectorXd *z_out, MatrixXd *S_out, MatrixXd &Zsig, MatrixXd &Xsig_pred);

    void PredictLidarMeasurement(VectorXd *z_out, MatrixXd *S_out, MatrixXd &Zsig, MatrixXd &Xsig_pred);
  };
